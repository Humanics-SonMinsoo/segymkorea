...
2. **소유 확인** — 아래 중 **하나만** 성공해도 됩니다.
   - **HTML 파일**: 저장소 `public/naver603a069df921dcb5566c6df25e62567d.html` 배포 후 `https://segymkorea.com/naver603a069df921dcb5566c6df25e62567d.html` 접속 확인 → 네이버 안내 링크와 동일한지 확인. (네이버에서 받은 원본 파일과 다르면, 다운로드한 파일 내용으로 이 파일을 교체하세요.)
