...
export const metadata: Metadata = {
  ...
  description: 'See SEGYM installations across premium fitness centers in Korea.',
}

/** Show a curated subset for the EN installations overview */
const FEATURED_IDS = ['29', '30', '27', '28', '18', '24', '20', '14'] as const

export default function EnInstallationsPage() {
  const items = FEATURED_IDS.map((id) => INSTALLATION_GALLERY.find((p) => p.id === id)).filter(
    Boolean,
  ) as typeof INSTALLATION_GALLERY
    ...
    <main className="bg-white">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <p className="mt-5 text-lg text-gray-600 max-w-2xl leading-relaxed">
          From premium gyms to PT studios and pro facilities — SEGYM is already training members across Korea.
        </p>
