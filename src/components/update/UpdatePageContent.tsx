  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/35 via-black to-black" />
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-[1.15] ko-modal-copy whitespace-pre-line">
              {C.heroTitle}
            </h1>
            <p className="mt-4 text-xl sm:text-2xl font-bold text-primary-light ko-modal-copy">
              {C.heroSubtitle}
            </p>
      ...
      <section id={neg.id} className="scroll-mt-28 border-b border-white/10 py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-2xl">
            <div className="rounded-2xl border border-primary/40 bg-primary/15 px-5 py-6 text-center">
              <p className="text-xs font-bold uppercase tracking-wider text-primary-light mb-2">내릴 때</p>
              <p className="text-4xl sm:text-5xl font-extrabold tabular-nums tracking-tight">100kg</p>
            </div>
            <div className="rounded-2xl border border-white/15 bg-neutral-950 px-5 py-6 text-center">
              <p className="text-xs font-bold uppercase tracking-wider text-neutral-400 mb-2">올릴 때</p>
              <p className="text-4xl sm:text-5xl font-extrabold tabular-nums tracking-tight">60kg</p>
            </div>
          </div>
          ...
          <div className="mt-10 rounded-2xl border border-primary/30 bg-primary/10 p-6 sm:p-8">
            <p className="text-sm sm:text-base text-neutral-200 leading-relaxed ko-modal-copy">
              이런 기능이 <strong className="text-white">2026 하반기</strong>에 업데이트됩니다. 기존 도입 센터에도{' '}
              <strong className="text-white">추가 비용 없이</strong> 제공될 예정입니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id={body.id} className="scroll-mt-28 border-b border-white/10 bg-neutral-950">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24">
          ...
          <p className="mt-5 text-xl sm:text-2xl font-bold text-brand-teal ko-modal-copy">{body.hook}</p>
          ...
          <div className="mt-10 rounded-2xl border border-white/10 bg-black/50 p-6 sm:p-8">
            <p className="text-sm font-bold tracking-wide text-brand-teal mb-4">이렇게 진행됩니다</p>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-primary to-primary-dark">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-white/80 mb-3">2026 H2 Update</p>
