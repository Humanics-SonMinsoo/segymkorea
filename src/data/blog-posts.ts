...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    categoryId: 'news',
    isNew: true,
    title: 'SEGYM DAY 4차, 8월 27일 부산 건담짐에서 진행됩니다',
    excerpt:
      '가격 인상 전 최저가로 세짐을 직접 만나볼 수 있는 프라이빗 초대 행사 SEGYM DAY가 지금 신청 접수 중입니다. 이번 4차는 8월 27일 오후 12시, 부산 건담짐에서 열립니다.',
    teaser: '운동시설 대표님·관장님을 위한 프라이빗 쇼케이스, 지금 신청하면 참여하실 수 있어요.',
    subjectLabel: '부산 건담짐',
    thumbnail: '/images/segym-day/segym-day-vip-share.png',
    dateLabel: '2026년 8월 13일',
    author: '세짐',
    href: '/segym-day',
  },
  {
