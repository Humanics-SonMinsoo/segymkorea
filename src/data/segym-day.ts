...
export const SEGYM_DAY_APPLY_ENABLED = true
...
/** 이벤트 안내 상단 이미지 */
export const SEGYM_DAY_EVENT_IMAGE = '/images/segym-day/segym-day-friend.png'

/** 홈 팝업·신청 페이지 배너 */
export const SEGYM_DAY_POPUP_IMAGE = '/images/segym-day/segym-day-friend.png'
...
export const SEGYM_DAY_COPY = {
  navLabel: 'SEGYM DAY',
  pageTitle: '9월 30일 시흥 프렌드짐 1호점 SEGYM DAY 참가신청',
  pageDescription: '',
  applyButton: 'SEGYM DAY 신청하기',
  aboutButton: '이벤트 알아보기',
  popupStorageKey: 'segym-day-popup-dismissed-v8',
  popupHideTodayKey: 'segym-day-popup-hide-today-v8',
  popupHeadline: '9월 30일 오후 1시, SEGYM DAY in 시흥 프렌드짐 1호점',
  popupSubline: '오직 운동시설 대표님들을 위한 이벤트',
  popupHideToday: '오늘 하루 종일 보지 않기',
  popupClose: '닫기',
  urgencyHeadline: '지금 신청하지 않으면 자리가 없어질 수 있습니다',
  urgencySubline:
    '5차 시흥 프렌드짐 1호점 SEGYM DAY는 사전 신청제로 진행됩니다. 마감 시 예약 창은 즉시 닫힙니다.',
  deadlineLabel: '9월 29일(화)',
  shareCardTitle: 'SEGYM DAY VIP 초대장',
  shareOgDescription: '당신을 초대합니다.\n9월 30일 오후 1시, 시흥 프렌드짐 1호점',
  shareInviteLine: '당신을 초대합니다.',
  shareEventWhen: '9월 30일 오후 1시, 시흥 프렌드짐 1호점',
  shareInviteBody: '',
