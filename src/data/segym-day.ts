...
export const SEGYM_DAY_COPY = {
  ...
  pageDescription:
    '선착순 20명 한정 · 8월 10일(월) 마감. 가격 인상 전 최저가로 세짐을 선점할 수 있는 마지막 기회, 대전 원퍼센트피트니스 SEGYM DAY에 참여해 보세요.',
  ...
  urgencySubline:
    '3차 대전 원퍼센트피트니스 SEGYM DAY는 선착순 20명만 참여 가능합니다. 20명 마감 시 예약 창은 즉시 닫힙니다.',
